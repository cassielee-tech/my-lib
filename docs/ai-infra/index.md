...
整个 AI Infra 阶段规划为 **5 个模块、22 个主题章**。每个主题章继续拆成若干个约 **15 分钟学习单元**；概念、推导、实验和博客输出分开完成。
...
这一阶段从 Collective 的最终语义进入通信算法、代价模型和工程优化，为后续在 CANN 模块中学习 HCCL 源码做好准备。
...
按每周完成 8～12 个单元推进，主线约需 4～5 个月。完成后进入 [CANN 模块](../cann/index.md)，学习昇腾平台与 HCCL 源码；遇到不熟悉的通用概念时，再回到对应前置单元补齐。
