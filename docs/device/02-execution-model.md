...
- **02-1（约 15 分钟）**：[三种执行哲学：CPU、GPU 与 NPU](02-execution-model/01-execution-philosophy.md)
- **02-2（约 15 分钟）**：[GPU 内部：SM、Warp 与 SIMT](02-execution-model/02-gpu-sm-warp-simt.md)
- **02-3（约 15 分钟）**：[NPU 内部：达芬奇架构与计算单元](02-execution-model/03-npu-davinci-core.md)
- **02-4（约 15 分钟）**：[从执行模型到利用率](02-execution-model/04-utilization-tail-effects.md)
