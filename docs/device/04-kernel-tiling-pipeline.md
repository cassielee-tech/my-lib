...
- **04-1（约 15 分钟）**：[Kernel 的解剖：入口、索引与启动开销](04-kernel-tiling-pipeline/01-kernel-anatomy.md)
- **04-2（约 15 分钟）**：[Tiling：把大算子切成块](04-kernel-tiling-pipeline/02-tiling-strategy.md)
- **04-3（约 15 分钟）**：[流水线与 Double Buffer](04-kernel-tiling-pipeline/03-pipeline-double-buffer.md)
- **04-4（约 15 分钟）**：[最小算子走读与调优检查单](04-kernel-tiling-pipeline/04-minimal-kernel-walkthrough.md)
