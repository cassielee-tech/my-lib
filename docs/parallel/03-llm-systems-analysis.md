...
**跟不动？** 先读 [⚡ 速通版（约 5 分钟）](03-llm-systems-analysis/quick.md)：一份"开店预算"类比讲完整章，再回来按单元深入。
...
- **03-1（约 15 分钟）**：[读配置并估算参数量](03-llm-systems-analysis/01-config-parameters.md)
- **03-2（约 15 分钟）**：[权重、KV Cache 与训练显存](03-llm-systems-analysis/02-model-memory.md)
- **03-3（约 15 分钟）**：[FLOPs 与完整数据流](03-llm-systems-analysis/03-flops-dataflow.md)
- **03-4（约 15 分钟）**：[模型切分、通信与性能模型](03-llm-systems-analysis/04-sharding-performance.md)

- **本章总结**：[串联知识、练习与检查](03-llm-systems-analysis/summary.md)
