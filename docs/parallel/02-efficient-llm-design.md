...
**跟不动？** 先读 [⚡ 速通版（约 5 分钟）](02-efficient-llm-design/quick.md)：一个"给出版社省钱"类比讲完整章，再回来按单元深入。
...
- **02-1（约 15 分钟）**：[MHA、MQA 与 GQA](02-efficient-llm-design/01-mha-mqa-gqa.md)
- **02-2（约 15 分钟）**：[量化原理、粒度与显存收益](02-efficient-llm-design/02-quantization.md)
- **02-3（约 15 分钟）**：[长上下文的四条优化路线](02-efficient-llm-design/03-long-context.md)
- **02-4（约 15 分钟）**：[把模型优化映射到算子与通信](02-efficient-llm-design/04-optimization-infra.md)

- **本章总结**：[串联知识、练习与检查](02-efficient-llm-design/summary.md)
