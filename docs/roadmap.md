...
默认周期为 **16 周，每周 8～10 小时**。工作繁忙时可以按主题完成度推进，不必机械追赶周数。
...
1. **预习**：阅读一份主资料，记录不理解的术语；
2. **讲解**：用自己的话回答“它解决什么问题、输入输出是什么、代价是什么”；
3. **动手**：完成一个最小实验或手工推导；
4. **关联**：说明它最终会触发哪类集合通信；
5. **输出**：整理一篇博客笔记；
6. **验收**：完成 5 个自测问题，不看资料画出核心流程。

建议每周时间分配：概念学习 3 小时、动手实验 3 小时、博客整理 2 小时、复习与自测 1～2 小时。
