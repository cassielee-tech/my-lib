...
**跟不动？** 先读 [⚡ 速通版（约 5 分钟）](#⚡-速通-约-5-分钟)：一个"座位号与时钟指针"类比讲完整章，再回来按单元深入。
...
- **06-1（约 15 分钟）**：[注意力为什么需要位置信息](#_06-1-注意力为什么需要位置信息)
- **06-2（约 15 分钟）**：[二维旋转与相对位置](#_06-2-二维旋转与相对位置)
- **06-3（约 15 分钟）**：[RoPE 的 Shape 与长上下文限制](#_06-3-rope-的-shape-与长上下文限制)
...
| 单元 | 讲什么（白话） | 什么时候需要它 |
| --- | --- | --- |
| [06-1 注意力为什么需要位置信息](#_06-1-注意力为什么需要位置信息) | 没有座位号会出什么乱子 | 想理解位置编码的必要性 |
| [06-2 二维旋转与相对位置](#_06-2-二维旋转与相对位置) | 指针数学的完整推导 | 想亲手验证"夹角=距离" |
| [06-3 RoPE 的 Shape 与长上下文限制](#_06-3-rope-的-shape-与长上下文限制) | 三道坎的展开 | 想做长上下文相关工作 |
